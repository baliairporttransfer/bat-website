...
export const metadata: Metadata = {
  title: 'Bali Airport Transfer to Tanah Lot | Sunset Temple Private Taxi | Transfer Bali',
  description: 'Book a reliable private airport transfer from Ngurah Rai International Airport to Tanah Lot with professional English speaking drivers, fixed pricing (IDR 370k), and 24/7 service.',
  alternates: {
    canonical: 'https://transferbali.com/airport-transfer-tanah-lot',
  },
  openGraph: {
    title: 'Bali Airport Transfer to Tanah Lot | Sunset Temple Private Taxi | Transfer Bali',
    description: 'Secure your private airport transfer from Ngurah Rai International Airport to Tanah Lot with professional English speaking drivers, fixed pricing (IDR 370k), and 24/7 support.',
    url: 'https://transferbali.com/airport-transfer-tanah-lot',
    siteName: 'Transfer Bali',
    images: [
      {
        url: 'https://transferbali.com/images/tanahlot-transfer-og.jpg',
        width: 1200,
        height: 630,
        alt: 'Private airport transfer to Tanah Lot sea temple from Bali Airport',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Bali Airport Transfer to Tanah Lot | Sunset Temple Private Taxi | Transfer Bali',
    description: 'Secure your private airport transfer from Ngurah Rai International Airport to Tanah Lot with professional English speaking drivers, fixed pricing (IDR 370k), and 24/7 support.',
    images: ['https://transferbali.com/images/tanahlot-transfer-og.jpg'],
  },
};
...
const jsonLd = {
  ...
  "@graph": [
    ...
    {
      "@type": "Service",
      "name": "Bali Airport Transfer to Tanah Lot",
      "provider": {
        "@id": "https://transferbali.com/#localbusiness"
      },
      "areaServed": {
      ...
      "description": "Reliable private airport transfer service from Ngurah Rai International Airport (DPS) to the iconic coastal temple and luxury resorts of Tanah Lot, Bali. Includes meet and greet, luggage handling, and air-conditioned vehicles.",
      "offers": {
        "@type": "Offer",
        "price": "370000",
        "priceCurrency": "IDR",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Airport Transfer to Tanah Lot"
        }
      ]
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How far is Tanah Lot from Bali Airport?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The driving distance from Ngurah Rai International Airport (DPS) to Tanah Lot is approximately 25 to 30 kilometers northwest along the coast. A private car transfer typically takes around 50 to 75 minutes depending on traffic conditions through Kuta and Canggu areas."
          }
        },
        {
          "@type": "Question",
          "name": "How much is a taxi from Bali airport to Tanah Lot?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Our private airport transfer to Tanah Lot has a fixed, all-inclusive price of IDR 370,000 per vehicle. This covers up to 4 passengers, standard luggage, fuel, toll fees, and professional driver services with zero hidden costs."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "Can you drop us off directly at Tanah Lot beach villas or coastal resorts?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! We provide direct door-to-door drop-off to any hotel, luxury villa, resort, or homestay in the Tanah Lot and Beraban area at no extra charge."
          }
        },
        {
          "@type": "Question",
          "name": "Do you provide baby car seats for trips to Tanah Lot?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Are late-night airport transfers available to Tanah Lot?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, our transfer service operates 24/7. Whether you land late at night or early in the morning, our professional local drivers ensure a safe and comfortable trip to Tanah Lot."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No advance payment is necessary. You can book your airport taxi to Tanah Lot securely through WhatsApp and pay your driver directly in cash upon safe arrival at your destination."
          }
        },
        {
          "@type": "Question",
          "name": "What vehicles do you use for Tanah Lot trips?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We deploy modern, well-maintained, fully air-conditioned private vehicles like the Toyota Avanza or Toyota Innova, ideal for comfortable coastal transit."
          }
        },
        {
          "@type": "Question",
          "name": "When should I book my transfer to Tanah Lot?",
          "acceptedAnswer": {
            "@type": "Answer",
...
export default function AirportTransferTanahLotPage() {
  const whatsappUrl = "https://wa.me/6285738217365?text=Hi%2C%20I%20would%20like%20to%20book%20an%20Airport%20Transfer%20to%20Tanah%20Lot.";
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <nav aria-label="Breadcrumb" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 text-sm text-slate-500 w-full">
        <ol className="flex items-center space-x-2">
          ...
          <li><span className="mx-2" aria-hidden="true">/</span></li>
          <li aria-current="page" className="text-slate-900 font-medium">Tanah Lot</li>
        </ol>
      </nav>
      ...
      <header className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20 flex flex-col lg:flex-row items-center gap-12 w-full">
        <div className="w-full lg:w-1/2 space-y-8 z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-sm font-semibold tracking-wide">
            ...
            Private Sea Temple Airport Transfer
          </div>
          <h1 className="text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight leading-tight">
            Bali Airport Transfer to <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-500">Tanah Lot</span>
          </h1>
          <p className="text-lg text-slate-600 leading-relaxed max-w-2xl">
            Arrive smoothly at Bali's stunning coastal sunset sanctuary with a secure <Link href="/airport-transfer-tanah-lot" className="text-emerald-700 underline underline-offset-2">airport transfer tanah lot</Link> directly from Ngurah Rai International Airport. Enjoy a comfortable private car, professional drivers, and fixed pricing.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4">
            <Link 
              href={whatsappUrl}
              aria-label="Book airport transfer to Tanah Lot via WhatsApp"
        ...
        <div className="w-full lg:w-1/2 relative">
          <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl relative bg-slate-100">
            <Image 
              src="/images/tanahlot-hero.jpg" 
              alt="Private car airport transfer arriving in Tanah Lot sea temple Bali" 
              fill
      ...
      <section id="pricing" className="bg-slate-50 py-20 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-4">Transparent Fixed Pricing to Tanah Lot</h2>
            <p className="text-slate-600 max-w-2xl mx-auto">Experience a comfortable coastal transfer service to Tanah Lot resorts and villas with absolute cost clarity.</p>
          </div>
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden flex flex-col md:flex-row">
            <div className="p-8 md:p-12 md:w-2/3">
              ...
              <p className="text-slate-500 mb-6">Optimized for coastal transit, offering comfortable air conditioning and ample luggage capacity for your beachside holiday.</p>
              
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div>
                  <p className="text-sm text-slate-400 font-medium uppercase tracking-wider mb-1">Distance</p>
                  <p className="text-lg font-semibold text-slate-900">~ 25 - 30 km</p>
                </div>
                <div>
                  <p className="text-sm text-slate-400 font-medium uppercase tracking-wider mb-1">Duration</p>
                  <p className="text-lg font-semibold text-slate-900">50 - 75 Mins</p>
                </div>
                <div>
            ...
            <div className="bg-slate-900 p-8 md:p-12 md:w-1/3 flex flex-col justify-center items-center text-center">
              ...
              <div className="text-white mb-6 flex items-baseline justify-center">
                ...
                <span className="text-5xl font-bold tracking-tight">370k</span>
              </div>
              <p className="text-slate-400 text-sm mb-8">Per vehicle, all inclusive</p>
              <Link 
                href={whatsappUrl}
                aria-label="Book your Tanah Lot transfer via WhatsApp"
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-4">Why Choose Transfer Bali for Your Tanah Lot Route</h2>
          <p className="text-slate-600 max-w-2xl mx-auto">Discover why travelers heading to Tanah Lot prefer our premier bali airport transfer tanah lot service.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            { title: 'Comfortable Fleet', desc: 'Travel safely through coastal roads inside fully air-conditioned, meticulously maintained, and sanitized vehicles.', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
            { title: 'Expert Local Drivers', desc: 'Our skilled English speaking chauffeurs possess extensive experience navigating west coast routes and traffic safely.', icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.243-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            ...
            {[
              ...
              { step: '04', title: 'Coastal Ride to Tanah Lot', desc: 'Settle back and enjoy a scenic journey northwest toward your Tanah Lot accommodation.' }
            ].map((item, i) => (
      ...
      <article className="py-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg prose-slate prose-headings:font-bold prose-headings:text-slate-900 prose-a:text-emerald-600 w-full">
        <h2 className="text-4xl text-center mb-12">The Ultimate Guide to Tanah Lot: Bali's Legendary Sea Temple and Coastal Haven</h2>
        
        <p>Tanah Lot is one of Bali's most iconic and photographed cultural landmarks, famous for its majestic offshore rock formation and ancient Hindu sea temple. Securing a dependable <Link href="/airport-transfer-tanah-lot" title="Bali Airport Transfer to Tanah Lot">private airport transfer tanah lot</Link> ensures you complete the 28-kilometer coastal journey from Ngurah Rai International Airport smoothly and comfortably.</p>

        <p>The drive from the airport to Tanah Lot typically takes between 50 to 75 minutes, passing through vibrant western districts. Booking an expert <strong>bali airport transfer tanah lot</strong> means your English speaking driver will monitor your flight schedule, greet you warmly upon arrival, and navigate roadways directly to your beach resort or villa.</p>

        <h3>Why Tanah Lot is Bali's Premier Sunset Destination</h3>
        <p>Tanah Lot offers an unforgettable introduction to Bali's spiritual coastal heritage. Perched atop a rocky outcrop beaten by ocean waves, the temple creates a mesmerizing silhouette against legendary golden-hour sunsets, attracting global travelers seeking both cultural depth and coastal tranquility.</p>

        <div className="not-prose my-12 bg-emerald-50 border border-emerald-200 rounded-2xl p-8 text-center">
          <h3 className="text-2xl font-bold text-slate-900 mb-3">Planning a Coastal Escape to Tanah Lot?</h3>
          <p className="text-slate-600 mb-6 max-w-xl mx-auto">Ensure a comfortable transit from the airport to Tanah Lot's scenic coastline. Reserve your private vehicle with a professional driver today.</p>
          <Link 
            href={whatsappUrl}
            aria-label="Book your airport transfer to Tanah Lot via WhatsApp"
          ...
          >
            Book Airport Transfer to Tanah Lot (IDR 370k)
          </Link>
        </div>

        <h3>Top Experiences and Attractions in Tanah Lot</h3>
        <p>Tanah Lot and its surrounding coastal area offer fantastic recreational and sightseeing attractions. Here are the top locations to explore during your stay:</p>
        <ol>
          <li><strong>Pura Tanah Lot:</strong> The iconic 16th-century sea temple resting on a rock formation accessible during low tide.</li>
          <li><strong>Batu Bolong Temple:</strong> A nearby temple perched on a magnificent rock arch extending into the ocean.</li>
          <li><strong>Pan Pacific Bali Golf Course:</strong> World-class championship golfing greens overlooking dramatic coastal cliffs.</li>
          <li><strong>Echo Beach & Canggu Border:</strong> Vibrant neighboring surf spots and trendy beachfront dining hubs just a short drive away.</li>
          <li><strong>Traditional Art Markets:</strong> Bustling walkways lined with Balinese handicrafts, sarongs, and souvenir shops.</li>
          <li><strong>Sunset Viewing Terraces:</strong> Clifftop cafes and restaurants providing unobstructed panoramic views of the ocean dusk.</li>
          <li><strong>Holy Snake Cave:</strong> A sacred cave near the temple housing guarded tame sea snakes.</li>
          <li><strong>Local Seafood Dining:</strong> Beachside warungs serving fresh catches grilled over coconut husks.</li>
          <li><strong>Luxury Coastal Resorts:</strong> High-end wellness retreats offering supreme privacy along the Beraban coastline.</li>
          <li><strong>Cultural Dance Performances:</strong> Periodic evening Kecak fire dance shows performed near the temple grounds.</li>
        </ol>

        <h3>Travel & Transport Tips for Tanah Lot</h3>
        <p>Navigating airport transits and coastal roads in western Bali requires proper planning. Keep these expert recommendations in mind:</p>
        <ul>
          <li><strong>Coastal Transit Convenience:</strong> Booking a reliable <Link href="/airport-transfer-tanah-lot" title="Tanah Lot Airport Taxi">airport taxi tanah lot</Link> guarantees an air-conditioned, spacious vehicle for your direct trip from the airport.</li>
          <li><strong>Sunset Traffic Management:</strong> Because afternoon traffic heading towards the west coast can build up, having an experienced local driver ensures efficient routing.</li>
          ...
          <li><strong>Experienced Local Drivers:</strong> Having a seasoned English speaking driver ensures you arrive relaxed at your coastal destination.</li>
        </ul>
      </article>
      ...
      <section className="bg-slate-50 py-24 w-full">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600">Everything you need to know about your taxi bali airport to tanah lot transfer.</p>
          </div>

          <div className="space-y-6">
            {[
              {
                q: "How far is Tanah Lot from Bali Airport?",
                a: "The driving distance from Ngurah Rai International Airport (DPS) to Tanah Lot is approximately 25 to 30 kilometers northwest along the coast. A private car transfer typically takes around 50 to 75 minutes depending on traffic conditions through Kuta and Canggu areas."
              },
              {
                q: "How much is a taxi from Bali airport to Tanah Lot?",
                a: "Our private airport transfer to Tanah Lot has a fixed, all-inclusive price of IDR 370,000 per vehicle. This covers up to 4 passengers, standard luggage, fuel, toll fees, and professional driver services with zero hidden costs."
              },
              {
              ...
              {
                q: "Can you drop us off directly at Tanah Lot beach villas or coastal resorts?",
                a: "Yes! We provide direct door-to-door drop-off to any hotel, luxury villa, resort, or homestay in the Tanah Lot and Beraban area at no extra charge."
              },
              {
                q: "Do you provide baby car seats for trips to Tanah Lot?",
              ...
              {
                q: "Are late-night airport transfers available to Tanah Lot?",
                a: "Yes, our transfer service operates 24/7. Whether you land late at night or early in the morning, our professional local drivers ensure a safe and comfortable trip to Tanah Lot."
              },
              {
                q: "Is a deposit required for the booking?",
                a: "No advance payment is necessary. You can book your airport taxi to Tanah Lot securely through WhatsApp and pay your driver directly in cash upon safe arrival at your destination."
              },
              {
                q: "What vehicles do you use for Tanah Lot trips?",
                a: "We deploy modern, well-maintained, fully air-conditioned private vehicles like the Toyota Avanza or Toyota Innova, ideal for comfortable coastal transit."
              },
              {
                q: "When should I book my transfer to Tanah Lot?",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { name: 'Tanah Lot', price: 'IDR 370,000', time: '50-75 mins', href: '/airport-transfer-tanah-lot', image: '/images/tanahlot-hero.jpg' },
          ...
          <div className="mt-12 text-center flex flex-wrap justify-center gap-4 text-sm text-slate-600">
            ...
            <span>•</span>
            <Link href="/airport-transfer-tanah-lot" className="hover:text-emerald-600 underline underline-offset-2">Airport Transfer Tanah Lot</Link>
            <span>•</span>
      ...
      <section className="bg-gradient-to-r from-emerald-900 to-teal-900 py-20 text-white w-full">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          <h2 className="text-3xl lg:text-5xl font-extrabold tracking-tight">Ready for Your Coastal Journey to Tanah Lot?</h2>
          <p className="text-emerald-100 text-lg max-w-2xl mx-auto leading-relaxed">Book your private <Link href="/airport-transfer-tanah-lot" className="text-white underline underline-offset-2 font-semibold">airport transfer tanah lot</Link> today. Enjoy a fixed price (IDR 370k) including toll fees, zero waiting stress, and an expert driver waiting right at Bali airport.</p>
          <div className="pt-4">
            <Link 
              href={whatsappUrl}
              aria-label="Book your Tanah Lot airport transfer via WhatsApp instantly"
      ...
      <footer className="bg-slate-950 text-slate-400 py-16 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            ...
            <Link href="/airport-transfer-tanah-lot" className="hover:text-white transition-colors">Tanah Lot</Link>
