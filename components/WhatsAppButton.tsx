...
export default function WhatsAppButton() {
  ...
  // Pesan otomatis yang lebih detail saat WhatsApp terbuka
  const message = "Hello Bali Airport Transfer, I would like to ask about airport transfer details, fleet availability, and custom routes. Can you help me?";

  const url = `https://wa.me/${phone}?text=${encodeURIComponent(message)}`;

  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 group">
      {/* Balon Teks Sapaan Kecil di Samping Tombol */}
      ...
      {/* Tombol Utama WhatsApp dengan Animasi Denyut */}
      <a
        href={url}
        target="_blank"
