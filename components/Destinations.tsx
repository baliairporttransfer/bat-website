...
const destinationRoutes: Record<string, string> = {
  ...
  amed: "/airport-transfer-amed",
  ubud: "/airport-transfer-ubud",
  uluwatu: "/airport-transfer-uluwatu",
  seminyak: "/airport-transfer-seminyak",
  "nusa-dua": "/airport-transfer-nusa-dua",
  sanur: "/airport-transfer-sanur",
  canggu: "/airport-transfer-canggu",
  "tanah-lot": "/airport-transfer-tanah-lot",
  tegallalang: "/airport-transfer-tegallalang",
  padangbai: "/airport-transfer-padangbai",
  bedugul: "/airport-transfer-bedugul",
  pemuteran: "/airport-transfer-pemuteran",
};
